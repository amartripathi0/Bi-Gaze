...
class PieChart2State extends State<PieChartObject> {
  int touchedIndex = -1;
        ...
        children: <Widget>[
          ...
          AspectRatio(
            ...
            child: PieChart(
              PieChartData(
                ...
                sections: showingSections(record.object, colors),
              ),
            ),
          ),
          ...
          Expanded(
            child: Padding(
              ...
              child: ListView(
                children: showingIndicators(record.object, colors),
              ),
            ),
          ),
        ],
  ...
  List<PieChartSectionData> showingSections(
    ...
    for (var item in audioData) {
      ...
      double value = double.parse(item.values.first.replaceAll('%', ''));
