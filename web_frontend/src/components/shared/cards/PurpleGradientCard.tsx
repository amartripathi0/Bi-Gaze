...
function PurpleGradientCard({children , additionalStyles} : {children : React.ReactNode , additionalStyles ?: string}) {
  return (
    <div className={`${additionalStyles} text-sm opacity-90 text-justify rounded-xl font-medium w-4/5 hover:shadow-lg hover:opacity-100 transition-all duration-150 hover:shadow-purple-500 p-6
